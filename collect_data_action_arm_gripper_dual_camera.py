...
from arm_gripper_collector import ArmGripperCollector, nonblocking_readline
...
def _prepare_dual_camera_run_with_id(
    *,
    ...
    """
    Same folder convention as realsense_dual_collect_2_folder_func.prepare_dual_camera_run,
    but forces the run_id so action/camera share the same timestamp.
    """
...
def main():
    ...
    print("Type: 'c' (close), 'o' (open), 'q' (quit) then Enter. Also press 'q' in OpenCV window to quit.\n")
